...
class WithdrawalResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            // quantity: asset units being withdrawn — stored at write time.
            'quantity'  => number_format((float) $this->quantity, 8, '.', ''),

            // amount: USD equivalent at the time of withdrawal request.
            'amount'    => number_format((float) $this->amount, 2),

            // rate: asset price when withdrawal was submitted.
